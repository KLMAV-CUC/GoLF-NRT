...
def center_pad(rgb, camera, src_rgbs, src_cameras, pad_size=(400, 600), center=None):
    pad_h, pad_w = pad_size[0], pad_size[1]
    src_rgbs = np.pad(src_rgbs, pad_width=((pad_w, pad_w), (pad_h, pad_h)), mode='constant', constant_values=0)
    rgb_out = np.pad(rgb, pad_width=((pad_w, pad_w), (pad_h, pad_h)), mode='constant', constant_values=0)
