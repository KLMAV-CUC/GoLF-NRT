...
class RaySamplerSingleImage(object):
    def __init__(self, data, device, resize_factor=1, render_stride=1):
        ...
        if "blender_mask" in data.keys():
            self.blender_mask = data["blender_mask"]
        else:
            self.blender_mask = None
    ...
    def get_all(self):
        ret = {
            ...
            "blender_mask": self.blender_mask if self.blender_mask is not None else None,
        }
        return ret
